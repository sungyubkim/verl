                ...
                with marked_timer("step", timing_raw):
                    ...
                    with marked_timer("adv", timing_raw, color="brown"):
                        ...
                        if reward_extra_infos_dict:
                            ...
                            # Track reward extra info keys (sorted for consistent ordering)
                            if "reward_extra_keys" not in batch.meta_info:
                                batch.meta_info["reward_extra_keys"] = sorted(reward_extra_infos_dict.keys())
